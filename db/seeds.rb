...
volvo = Vehicle.create({make: "Volvo", model: "S70", year: 2002, vin: "1G4PP5SK6E4195118", engine: "2.3L IL6", car_type: "4door", color: "white"})
...
vw_part2 = Part.create({part_number: "221-300-891B", part_name: "EMPI Fuel Regulator", cost: 45, part_type: "Fuel", quantity: 1, vendor_id: 3})
audi_part1 = Part.create({part_number: "114-908040", part_name: "Head Gaskets", cost: 130, part_type: "Engine", quantity: 1, vendor_id: 4})
audi_part2 = Part.create({part_number: "114-578937", part_name: "Audi Oil Filter", cost: 30, part_type: "Engine", quantity: 1, vendor_id: 5})
volvo_part1 = Part.create({part_number: "vv70-567-9080", part_name: "OEM Rear Window Regulator", cost: 237, part_type: "Interior", quantity: 1, vendor_id: 1})
volvo_part2 = Part.create({part_number: "vv70-700-3386", part_name: "Transmission Fluid", cost: 23, part_type: "Transmission", quantity: 2, vendor_id: 2})
