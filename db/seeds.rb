...
ryan = Owner.create({name: "Ryan Riesenberger", street: "105 Northampton", city: "Canton", state: "GA", zip: 30115, phone_number: "619-508-0510", email: "rjriesenberger@gmail.com"})
sunny = Owner.create({name: "Sunny Sharam", street: "9421 Peachtree Dr.", city: "Duluth", state: "GA", zip: 30110, phone_number: "678-390-0000", email: "ssharam@gmail.com"})
...
volvo = Vehicle.create({make: "Volvo", model: "S70", year: 2002, vin: "1G4PP5SK6E4195118", engine: "2.3L IL6", car_classification: "4door", color: "white", owner_id: 2})
# t.string "make"
# t.string "model"
# t.integer "year"
# t.string "vin"
...
bmw_service1 = Service.create({date: "01/20/2019", work_description: "Changed oil and filter", car_miles: 123100, work_hours: 2})
bmw_service2 = Service.create({date: "03/13/2019", work_description: "Changed rear brake pads", car_miles: 126130, work_hours: 4})
vw_service1 = Service.create({date: "01/09/2019", work_description: "Replaced leaky drum cylinder", car_miles: 10120, work_hours: 5})
vw_service2 = Service.create({date: "01/20/2019", work_description: "Replaced fuel regulator", car_miles: 10320, work_hours: 4})
audi_service1 = Service.create({date: "01/12/2019", work_description: "Replaced head gaskets", car_miles: 45678, work_hours: 6})
audi_service2 = Service.create({date: "02/28/2019", work_description: "Changed oil and filter", car_miles: 47891, work_hours: 1})
volvo_service1 = Service.create({date: "01/15/2019", work_description: "Replaced rear window regulator", car_miles: 90340, work_hours: 3})
volvo_service2 = Service.create({date: "04/12/2019", work_description: "Changed transmission fluid", car_miles: 94901, work_hours: 4})
...
vw_part2 = Part.create({part_number: "221-300-891B", part_name: "EMPI Fuel Regulator", cost: 45, part_designation: "Fuel", quantity: 1, vendor_id: 3})
audi_part1 = Part.create({part_number: "114-908040", part_name: "Head Gaskets", cost: 130, part_designation: "Engine", quantity: 1, vendor_id: 4})
audi_part2 = Part.create({part_number: "114-578937", part_name: "Audi Oil Filter", cost: 30, part_designation: "Engine", quantity: 1, vendor_id: 5})
volvo_part1 = Part.create({part_number: "vv70-567-9080", part_name: "OEM Rear Window Regulator", cost: 237, part_designation: "Interior", quantity: 1, vendor_id: 1})
volvo_part2 = Part.create({part_number: "vv70-700-3386", part_name: "Transmission Fluid", cost: 23, part_designation: "Transmission", quantity: 2, vendor_id: 2})
